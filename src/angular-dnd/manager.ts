...
export const DRAG_DROP_MANAGER = new InjectionToken<DragDropManager>("dnd-core manager");
...
export function managerFactory(backend, zone: NgZone, context={'window': window}) {
  // support es5
  if (backend.default) {
    backend = backend.default;
  }
